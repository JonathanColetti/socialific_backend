...
const resolvers = {
    ...
    Query: {
        userauth: async (parent: any, args: {uid: string, email: string, phonenum: string, password: string}, context: any, info: any) => {
            return await resolveUserAuth(args.uid, args.email, args.phonenum, args.password)
        },
        ...
        posts: async (parent: any, args: {uid: string}, context: any, info: any) => {
            return await resolvePosts(args.uid)
        }        
